...
<br/><br/>
	<div style="text-align:center;clear:both;top:10px;">
		<span style="font-weight:bold; font-size:20px; font-family:'Times New Roman';">EERE Budget for FY <?php echo $years[0] ?></span><br/><br/>
		<span style="font-size:12px; font-family:Georgia;">EERE Total: <?php echo number_format($programTotal) ?> (Dollars in Thousands) </span>
	</div>
